  ...
  return (
    <div className="my-10">
      ...
      <div className="flex justify-center items-center flex-wrap gap-4">
        {/* cards */}
        <div className="w-[300px] h-[481px] p-10 bg-gray-100 rounded-xl text-center">
          {/* image */}
          <img src="2.png" width={"170px"} height={"170px"} alt="" />
          <h1 className="my-5">الاختيار من اجابتين</h1>
          <svg
